...
public class KVPairTest extends TestCase{
    ...
    public void setUp() {
        ...
        pair = new KVPair<String,Rectangle>("start",new Rectangle(1,2,5,5));
    ...
    public void testCompareToKVPair() {
        ...
        KVPair<String,Rectangle> pair2 = new KVPair<String,Rectangle>("middle",new Rectangle(5,5,5,5));
        assertTrue(pair.compareTo(pair2) >= 1);
        assertFalse(pair.compareTo(pair2) < 1);
        KVPair<String,Rectangle> pair3 = new KVPair<String,Rectangle>("zzzzzz",new Rectangle(-100,-100,-100,-100));
    ...
    public void testKey() {
        ...
        KVPair<String,Rectangle> pair3 = new KVPair<String,Rectangle>(null, new Rectangle(5,5,5,5));
        assertNull(pair3.key());
        KVPair<String,Rectangle> pair4 = new KVPair<String,Rectangle>("",new Rectangle(5,5,5,5));
    ...
    public void testValue() {
        ...
        KVPair<String,Rectangle> pair3 = new KVPair<String,Rectangle>("null", null);
